    ...
    while (1) {
        ...
        switch (choice) {
            ...
            case 2:
                ...
                break;
            case 3:
                printf("Enter Product ID to view details: ");
                scanf("%d", &id);
...
// 5. **View Product Details Function**:
//    - Prompts the user to enter the product ID to view.
//    - Displays the details of the specified product if found; otherwise, notifies the user that the product ID is not found.
// 6. **Main Function**:
//    - Provides a menu to add product details, display products, view product details, or exit the program.
//    - Executes the selected option based on user input.

// This basic program allows you to add, view, and display product details in a super shop management system. Feel free to customize it further to meet your specific needs!